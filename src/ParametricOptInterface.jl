...
function MOI.get(model::ParametricOptimizer, attr::T, c::MOI.ConstraintIndex) where {
                                                                                        T <: Union{
...
function add_constraint_with_parameters_on_function(model::ParametricOptimizer, f::MOI.VectorAffineFunction{T}, set::MOI.AbstractVectorSet) where T  
